...
namespace CotLTemplateMod.Items
{
    internal class ExampleItem : CustomInventoryItem
    {
        ...
        public override string LocalizedDescription() { return "Followers wearing this necklace are caffenated. They do not sleep, and walk faster than others."; }
        public override string	LocalizedLore()	{ return "All speed, no sleep."; }
